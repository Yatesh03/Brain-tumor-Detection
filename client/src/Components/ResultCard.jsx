    ...
    return (
        <Container>
            ...
            <Body>
                ...
                <Description  prediction={!hasTumor}>{!hasTumor ? "According to our prediction on basis of our ML model there is a possibility on no tumor detected in the image.": "According to our prediction on basis of our ML model there is a possibility on tumor detected in the image." }</Description>
                <File>File: {image.file_name}</File>
                <Probablity  prediction={!hasTumor}>Accuracy: {Math.round(probability*100)/100}%</Probablity>
            </Body>
        </Container>
    )
}
